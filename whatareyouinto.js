...
function submitAnswers() {
    ...
    if ((iAM === iMasc && imINTO === theyFem) || (iAM === iFem && imINTO === theyMasc)) {
        ...
        div.insertAdjacentHTML("afterend", straight);
    }
        ...
        div.insertAdjacentHTML("afterend", gay);
    }
        ...
        div.insertAdjacentHTML("afterend", bisexual);
    }
        ...
        div.insertAdjacentHTML("afterend", asexual);
    }
    else {
        ...
        div.insertAdjacentHTML("afterend", noans);
    }
}
