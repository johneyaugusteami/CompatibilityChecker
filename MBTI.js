...
function submitAnswers() {
    ...
    let
        ...
        goodCompatibility = "<br/> <h1 style='color:#008000;margin: auto;width: 50%;border: 3px solid #ec858d;padding: 10px;background-color:#C1C1C1;'>Good Estimated Compatibility 🙂 <br> ⭐⭐⭐⭐</h1>",
        mediumCompatibility = "<br/> <h1 style='color:#FF9900;margin: auto;width: 50%;border: 3px solid #ec858d;padding: 10px;background-color:#C1C1C1;'>Medium Estimated Compatibility 😅 <br> ⭐⭐⭐</h1>",
        lowCompatibility = "<br/> <h1 style='color:#e3242b;margin: auto;width: 50%;border: 3px solid #ec858d;padding: 10px;background-color:#C1C1C1;'>Low Estimated Compatibility 😢<br> ⭐⭐</h1>",
        veryGoodCompatibility = "<br/> <h1 style='color:#3D85C6;margin: auto;width: 50%;border: 3px solid #ec858d;padding: 10px;background-color:#C1C1C1;'>Very Good Estimated Compatibility 🥰 <br> ⭐⭐⭐⭐⭐</h1>",
